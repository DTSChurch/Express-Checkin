...
{
    [DisplayName("QR Express Time Select")]
    ...
    public partial class QRExpressTimeSelect : CheckInBlock
    {
...
", lbSelect.ClientID, hfTimes.ClientID );
        ...
        private void AutoSelect()
        {
            if (KioskCurrentlyActive)
            {
                ...
                var selectedIDs = attendanceService.Queryable()
                    .Where(a =>
                       a.ForeignKey == CurrentCheckInState.CheckIn.SearchValue)
                    .Select(a => a.Occurrence.ScheduleId);
