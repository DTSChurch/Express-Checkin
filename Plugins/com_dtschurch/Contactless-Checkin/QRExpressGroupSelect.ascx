<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QRExpressGroupSelect.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.ContactlessCheckin.QRExpressGroupSelect" %>
