<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QRExpressGroupTypeSelect.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.ContactlessCheckin.QRExpressGroupTypeSelect" %>
