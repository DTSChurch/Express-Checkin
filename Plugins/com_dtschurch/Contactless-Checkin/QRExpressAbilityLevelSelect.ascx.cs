...
{
    [DisplayName("QR Express Ability Level Select")]
    ...
    public partial class QRExpressAbilityLevelSelect : CheckInBlockMultiPerson
    {
                        ...
                        if (!string.IsNullOrWhiteSpace(personAbilityLevel))
                        {
                            foreach (var groupType in person.GroupTypes.ToList())
                            {
                                foreach (var group in groupType.Groups.ToList())
                                {
                                    ...
                                    {
                                        person.StateParameters.AddOrReplace("AbilityLevel", groupAttributes.ToString());
