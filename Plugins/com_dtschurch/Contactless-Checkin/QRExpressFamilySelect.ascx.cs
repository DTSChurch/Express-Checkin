...
{
    [DisplayName( "QR Express Family Select" )]
    ...
    [TextField( "No Option Message", 
        ...
        order: 7,
        key: "NoOptionMessage" )]
    [TextField("QR Code Invalid Message",
        description: "Text to display when the QR code returned no families to checkin",
        required: false,
        defaultValue: "This QR Code is no longer valid. It did not return a family to be checked in.",
        category: "Text",
        order: 7,
        key: "QRCodeInvalidMessage" )]
        
    public partial class QRExpressFamilySelect : CheckInBlock
    {
        /// <summary>
        ...
        private void BindResults()
        {
            ...
            {
                maWarning.Show(GetAttributeValue("QRCodeInvalidMessage"), ModalAlertType.Warning);
            }
