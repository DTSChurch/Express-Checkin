<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QRExpressWelcome.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.ContactlessCheckin.QRExpressWelcome" %>
<style>
    .js-search-value {
        position: absolute;
        top: 200px;
                    ...
                    if ($(".js-active").is(":visible")) {
                        ...
                        if (e.which == 13) {
                            if (keyboardBuffer.length != 0 && !swipeProcessing) {
                                ...
                                //$('#loading-spinner-after-scan').show();
                                window.clearTimeout(timeout);
                               window.setTimeout(refreshKiosk, timeoutSeconds * 1000)
                                window.location = "javascript:__doPostBack('hfSearchEntry', 'Attendance_Foreign_Key_Search')";
                            }
                        }
                        else {
                ...
                <div class="checkin-scroll-panel">
                    <div class="scroller">
                        ...
                        <div class="checkin-search-actions checkin-start">
                            <asp:Literal ID="lScanTextHtml" runat="server" />
                            <div  id="loading-spinner-after-scan" style="display: none">

                                <i class='fas fa-check-square fa-3x'></i> <br />
                                Loading...
                            </div>
                        </div>
                    </div>
