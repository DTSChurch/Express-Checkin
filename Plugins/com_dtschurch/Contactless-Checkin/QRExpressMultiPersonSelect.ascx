<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QRExpressMultiPersonSelect.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.ContactlessCheckin.QRExpressMultiPersonSelect" %>
